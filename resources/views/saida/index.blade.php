        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <h3 class="card-title">Listagem de Saídas</h3><br>
              <a href="{{ route('saida.create') }}">
              ...
              <table class="table table-hover">
                ...
                @foreach($data as $datum)
                  <tr>
                    ...
                    <td>{{$datum->data}}</td>
                    <td>{{$datum->valor}}</td>
                    <td>{{$datum->setor_id}}</td>
                    <td><a href="{{route('saida.edit', ['data' => $datum->id])}}" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i></a>
                      {{ Form::open(['route' => ['saida.destroy', $datum->id], 'method' => 'DELETE', 'style' => 'display:inline']) }}
